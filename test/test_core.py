...
class TestCore:
    ...
    def test_seqio(self, tmpdir, data):
        ...
        d2 = SequenceData(s2, cds=False, to_stop=True, **kwargs)
    ...
    def test_paranome(self, data, tmpdir):
        ...
        s1, s2 = data
        d = SequenceData(s1, out_path=tmpdir, tmp_path=tmpdir, cds=False, cscore=None, to_stop=False)
        d.get_paranome()
        ...
        families = d.write_paranome(False,singletons=False)
    ...
    def test_ksd(self, data, tmpdir):
        ...
        ksdb = KsDistributionBuilder(gfams,d)
